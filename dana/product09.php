  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide25.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">움직임 속에서도<br /> 배움은 멈추지 않습니다</h3>
          <p class="mt30 f20 white">복도는 이동의 경로이자 일상의 배움과 소통이 이어지는 유기적 공간입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide26.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">아이가 주인공이 되는<br /> 전시 공간</h3>
          <p class="mt30 f20 white">아이들의 작품과 각 반의 개성을 담은 아트월은 자긍심과 소속감을 길러줍니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide27.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">정돈된 수납과 <br />정서 자극을 동시에</h3>
          <p class="mt30 f20 white">사물함, 게시판, 알림 요소들이 공간의 흐름을 방해하지 않도록<br /> 정갈한 디자인과 컬러 밸런스를 적용합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>유치원의 복도는 단순한 통로가 아닌,<br /> 아이들의 동선 중심 허브이자 심리적 안전지대, 학습의 연장선입니다.</p>
        <p class="mt20">다나는 복도를 유희-학습-소통이 흐르는 다기능 공간으로 정의합니다. 원목 마감의 따뜻한 벽면, 낮은 눈높이의 아트월, 부드러운 조명은 아이들이 복도를 지루하지 않고, 위험하지 않게 이용할 수 있도록 설계합니다. 사물함과 게시판은 일직선 배열이 아닌 리듬감 있는 배치를 통해 흐름을 깨지 않고, 시선을 자연스럽게 유도합니다.</p>
        <p class="mt20">라운딩 처리된 안전형 사물함 및 벤치 수납, 교실별 컨셉에 맞춘 반 패(반 아이덴티티) 디자인 커스터마이징, 정기 교체 가능한 테마형 아트월 구조, 원목 마감 + 흡음 패널을 활용한 정서적 안정감 제공이 다나만의 차별 포인트입니다.</p>
        <img src="images/product/content33.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">정보 전달 + 반 아이덴티티 표현</h5>
          <p>각 교실 앞에 설치된 게시판, 반패(이름/로고/컬러 컨셉)는 시각적으로 뚜렷하고 아이 중심으로 표현되어야 합니다.<br /> 학부모와 방문객에게도 한눈에 반 분위기를 전달할 수 있습니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">안전한 통행과 수납의 조화</h5>
          <p>아이들이 뛰거나 부딪힐 수 있는 복도에서는 모서리 없는 라운딩 가구, 낮은 높이의 벤치형 사물함,<br /> 간결한 배치와 선형 조명이 안전성과 질서를 유지해줍니다.</p>
        </li>
      </ul>
    </div>
  </div>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">아트월 + 반 아이덴티티 구성</h5>
          <p class="mt30">각 교실 출입구 앞 벽면은 아이 작품 전시 + 반 이름/컬러/캐릭터 연출을 통해<br /> 또 하나의 창의 표현 공간이 됩니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content34.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">안전한 사물함 및 벤치 수납</h5>
          <p class="mt30">원목 소재의 낮은 사물함은 개별 수납과 앉는 기능을 겸하며,<br /> 라운딩 처리와 환기 홀 디자인으로 안전성과 위생성을 모두 확보합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content35.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">자연광과 간접조명의 흐름</h5>
          <p class="mt30">복도를 밝고 따뜻하게 연출하기 위해 자연광 유입 경로 확보,<br /> 벽면 조도 반사 설계, 간접조명을 통한 정서적 안정이 고려됩니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content36.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd09_01.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">아트월</h5>
      ...
      <li class="p30">
        <img src="images/product/prd09_02.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">사물함</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd09_03.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">게시판</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
