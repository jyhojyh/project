  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide22.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">하루의 시작을 맞이하는<br /> 따뜻한 공간</h3>
          <p class="mt30 f20 white">아이가 가장 먼저 마주하는 현관은 유치원의 인상을 결정짓는 공간입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide23.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">정리, 안내, 휴식이<br /> 동시에 이루어지는 구조</h3>
          <p class="mt30 f20 white">신발 정리, 게시판, 대기소파, 출결 확인이 유기적으로 배치되어<br /> 보호자와 아이 모두가 편하게 이용할 수 있습니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide24.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">감성과 위생이<br /> 공존하는 설계</h3>
          <p class="mt30 f20 white">따뜻한 원목과 부드러운 조명은 안정감을 주며,<br /> 간결한 수납과 위생구역 분리는 건강을 지켜줍니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>현관은 아이의 하루가 시작되고 마무리되는 곳이자,<br /> 외부와 내부의 경계, 학부모와 교사, 아이가 만나는 공간입니다.</p>
        <p class="mt20">첫인상으로서의 감성 연출, 직관적인 안내 시스템, 그리고 아이 눈높이에 맞춘 정리 수납으로 안전하고 쾌적한 공간을 구성합니다. 모듈형 원목 신발장, 부드러운 곡선 라인의 대기소파, 이동형 게시판 등을 통해 명확한 구획 + 유연한 사용을 모두 구현합니다.</p>
        <p class="mt20">정돈된 구조로 교통 흐름이 원활한 현관, 소음과 혼잡을 완화시키는 흡음재 활용 설계, ESG 관점의 친환경 소재 사용과 분리 수납 가구 적용이 다나만의 차별 포인트입니다.</p>
        <img src="images/product/content29.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">안내와 커뮤니케이션 중심 공간</h5>
          <p>게시판, 안내 키오스크, 출결 확인대 등은 가시성과 직관적 동선이 중요합니다.<br /> 입구에 들어서자마자 자연스럽게 정보를 인지하고 행동할 수 있는 설계를 해야 합니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">위생과 정리 기능 강조</h5>
          <p>신발장, 외투 보관, 대기공간은 청결한 동선 분리가 핵심입니다.<br /> 원목 신발장, 분리형 벤치, 이동식 알림판 등을 통해 위생성과 접근성을 동시에 확보할 수 있습니다.</p>
        </li>
      </ul>
    </div>
  </div>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">아이 중심의 동선 설계</h5>
          <p class="mt30">교사와 보호자의 동선과 겹치지 않도록, 아이 전용 공간을 시야 안에서 안전하게 분리합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content30.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">안정감 있는 원목 디자인</h5>
          <p class="mt30">무채색+내추럴톤의 원목 마감은 첫 공간에 부드러운 인상을 주며,<br /> 심리적으로도 안정 효과를 줍니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content31.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">휴식과 대기공간의 겸용 설계</h5>
          <p class="mt30">낮은 대기 벤치와 수납 겸용 가구를 함께 배치해,<br /> 아이는 앉고, 보호자는 정리하며 기다릴 수 있도록 구성합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content32.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd08_01.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">신발장</h5>
      ...
      <li class="p30">
        <img src="images/product/prd08_02.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd08_03.png" alt="" class="img-responsive center-block" />
