  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide28.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">몸과 마음이<br /> 함께 자라는 공간</h3>
          <p class="mt30 f20 white">자유로운 움직임, 표현, 상호작용이 어우러지는 유희실은 아이의 신체·정서 발달을 이끕니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide29.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">탐색, 도전, 성취<br /> 아이의 경험을 설계하다</h3>
          <p class="mt30 f20 white">균형·점프·움직임을 통해 아이는 스스로의 몸과 세상을 이해해 갑니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide30.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">충돌 없이 <br /> 안심할 수 있는 원목 공간</h3>
          <p class="mt30 f20 white">부드러운 마감, 라운딩 처리, 탄성 있는 구조는 활동 중의 안전을 보장합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>유희실은 아이가 몸으로 세상과 소통하고, 감정을 해소하고, 상호작용을 배우는 공간입니다.<br /> 정적인 교실과 달리, 활동성·탄성·유연성이 강조되어야 하며 동시에 안전성도 확보돼야 합니다.</p>
        <p class="mt20">다나는 유희실을 단순 '놀이 공간'이 아닌 균형 잡힌 감각 통합 공간으로 봅니다.<br /> 원목의 따뜻한 감성은 과도한 자극 없이 아이의 안정감을 이끌어냅니다. 유연하게 구성 가능한 모듈 가구와 파티션은 활동의 다양성을 열어줍니다.</p>
        <p class="mt20">곡선형 마감과 충격완화 구조는 안전 사고를 예방하며, 소리, 조명, 시야까지 고려한 공간 연출은 유희실을 하나의 통합 감각 경험장으로 완성합니다.</p>
        <img src="images/product/content37.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">신체 활동 중심 구조</h5>
          <p>아이들이 자유롭게 뛰고 구르고 넘을 수 있도록<br /> 장애물 없는 중심 동선, 이동형 바닥 구조, 높이감 있는 오픈 공간이 필수입니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">정서적 안정과 충돌 예방</h5>
          <p>과한 컬러나 반사 재료를 배제하고, 무채색과 원목 톤의 조화, 간접조명 활용, 모서리 라운딩 처리로<br /> 심리적 안정과 안전사고 예방을 함께 고려합니다.</p>
        </li>
      </ul>
    </div>
  </div>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">모듈형 이동 가구와 탄성 매트</h5>
          <p class="mt30">가벼운 체육 기구, 스텝 박스, 이동형 벤치 등은<br /> 활동에 따라 유연하게 배치가 가능해 공간의 활용도를 극대화합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content38.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">곡선 중심의 안전 가구 디자인</h5>
          <p class="mt30">경사진 미끄럼틀, 곡선 벽장, 곡면 쿠션 가구는<br /> 활동 중의 충돌 위험을 낮추고, 부드러운 분위기를 형성합니다</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content39.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">소리와 빛을 고려한 감각 환경</h5>
          <p class="mt30">소리의 잔향을 줄이는 흡음 재질, 간접 조명과 자연광 유입 설계로<br /> 과도한 자극 없이 몰입과 안정이 공존하는 공간을 만듭니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content40.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd10_01.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd10_02.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">라운지용 의자</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd10_03.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd10_04.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd10_05.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">유희실가구</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
