  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide07.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">이용자의 첫인상을<br /> 만드는 공간</h3>
          <p class="mt30 f20 white">도서관 전체 분위기를 결정짓는 시각적 중심으로, 기능성과 심미성을 모두 담아야 합니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide08.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">모든 동선이<br /> 교차하는 허브</h3>
          <p class="mt30 f20 white">출입, 문의, 반납, 등록 등 다양한 활동이 동시에 이뤄지는 공간.<br /> 명확한 구조와 효율적 배치가 중요합니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide09.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">단단하면서도<br /> 부드러운 환대</h3>
          <p class="mt30 f20 white">고정된 구조와 안정된 소재의 안내데스크는 신뢰감과 편안함을 함께 전달합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>안내데스크는 단순한 기능 공간이 아닌, 도서관의 첫인상을 결정짓는 얼굴입니다. 이용자와의 첫 접점을 고려한 접근성, 응대성, 시인성, 그리고 공간 정체성 표현까지 모두 반영된 설계가 필요합니다.</p>
        <p class="mt20">다나는 안내데스크를 단순한 가구가 아닌 공간의 중심 구조물로 바라봅니다. 동선의 허브이자 시각적 기준점으로 작동해야 하며, 이용자와 직원 모두에게 편리하고 직관적인 동선이 확보되어야 합니다.</p>
        <p class="mt20">원목 기반 구조는 안정적이고 포근한 분위기를 연출하면서도, 내구성과 구조감 측면에서도 우수하여 지속적인 사용에 최적화된 공간 가구 구성을 가능하게 합니다. 다나는 국내 다수의 공공도서관에서 안내데스크를 공간의 핵심 앵커로 설계한 경험을 바탕으로, 각 공간의 정체성과 브랜드 톤을 자연스럽게 담아내는 디자인 일체형 안내공간을 제공합니다.</p>
        <img src="images/product/content09.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">시인성과 공간 중심성 확보</h5>
          <p>이용자가 입장과 동시에 쉽게 찾을 수 있는 시각적 중심을 형성합니다.<br /> 재질과 컬러, 배치각, 높낮이 등을 조정해 공간의 흐름을 자연스럽게 유도합니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">기능성과 응대 효율성</h5>
          <p>대면 응대, 자료 확인, 회원 등록, 반납 등 다양한 서비스가 빠르게 이루어질 수 있도록<br /> 가구 높이, 동선 접근, 시스템 연계(PC·스캐너) 설치 위치까지 세밀하게 설계합니다.</p>
        </li>
      </ul>
    </div>
  </div>
  ...
  <ul class="mt60">
    <li class="flex flex-wrap items-center">
      <div class="wrap col-2">
        ...
        <h5 class="mt10 f30 fw8">원목 기반의 구조적 안정감</h5>
        <p class="mt30">친환경 원목 소재는 고정된 구조물에 심리적 안정감을 부여하며,<br /> 공간의 중심에 자연스럽게 녹아드는 시각적 따뜻함을 더합니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content10.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      <div class="wrap col-2">
        <span class="mont f20 fw6 main-c">02</span>
        <h5 class="mt10 f30 fw8">다기능 대응 설계</h5>
        <p class="mt30">문의, 검색, 반납, 안내 등 복합 기능을 효율적으로 수행할 수 있는<br /> 모듈형 구성 + 전면 가시성 + 다면 응대 시스템을 설계합니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content11.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      <div class="wrap col-2">
        <span class="mont f20 fw6 main-c">03</span>
        <h5 class="mt10 f30 fw8">브랜드 톤 반영 가능</h5>
        <p class="mt30">컬러 포인트, 로고 그래픽, 메시지 패널 등<br /> 도서관의 정체성과 디자인 방향성을 안내데스크에 유기적으로 통합합니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content12.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
  </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd03_01.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd03_02.png" alt="" class="img-responsive center-block" />
