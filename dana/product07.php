  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide19.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">놀고, 배우고, 쉬는 하루가<br />자연스럽게 연결되는 곳</h3>
          <p class="mt30 f20 white">활동과 휴식, 학습이 유기적으로 이루어지는 보육실은 아이의 일상 리듬을 만들어줍니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide20.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">아이 스스로 공간을<br /> 인식하고 사용하는 설계</h3>
          <p class="mt30 f20 white">탐색과 선택의 자유를 높인 가구 배치는 자율성과 사회성 발달에 기여합니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide21.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">성장하는 아이를 위한<br /> 안전한 배려</h3>
          <p class="mt30 f20 white">넘어지지 않도록 낮은 무게중심, 둥근 모서리, 안정감 있는 원목 가구로<br /> 건강한 놀이환경을 만듭니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>보육실(3~5세)은 자기 표현과 사회적 상호작용이 본격화되는 시기로, 공간은 단지 보호의 기능을 넘어 아이의 주도성을 끌어내는 설계가 필요합니다.</p>
        <p class="mt20">다나는 아이들이 '공간을 통해 배우고 자라나는 경험'을 하도록, UX 기반으로 동선, 가구, 컬러, 조명을 설계합니다. 저자극 톤과 원목 가구의 온기, 자율적 탐색을 유도하는 '열린 수납', 정리 습관을 유도하는 시각적 구조, 활동 → 집중 → 휴식의 리듬 흐름에 맞춘 공간 배치.</p>
        <p class="mt20">아이의 눈높이에서 '내 공간'을 느낄 수 있도록 기능과 감성이 균형을 이루는 다나만의 친환경 원목 가구 시리즈가 최적의 해답입니다.</p>
        <img src="images/product/content25.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">주도성과 자율성 확보</h5>
          <p>3~5세는 스스로 판단하고 행동하는 경험을 통해 사회성을 익히는 시기입니다.<br /> 정리정돈이 쉬운 수납 가구, 분리된 활동 공간, 적당한 개방성이 핵심입니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">안전과 다양성의 균형</h5>
          <p>이 시기의 아이들은 활동성이 높아져 부딪힘, 낙상 등의 위험이 증가합니다.<br /> 충격 완화 구조, 라운딩 마감, 단단한 고정 구조를 통해 자유로운 활동과 안전을 동시에 고려해야 합니다.</p>
        </li>
      </ul>
    </div>
  </div>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">자기 주도적 정리·탐색 환경</h5>
          <p class="mt30">아이의 키에 맞는 개방형 수납장은 정리 습관을 돕고,<br /> 관심 있는 물건을 스스로 찾으며 '내 공간'에 대한 감각을 형성하게 합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content26.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">활동 공간과 휴식 공간의 자연스러운 구분</h5>
          <p class="mt30">파티션형 가구나 톤을 달리한 바닥재 등을 활용하여,<br /> 놀이/학습/휴식이 서로 방해받지 않도록 리듬감을 설계합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content27.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">감성적 안정감을 주는 원목 텍스처</h5>
          <p class="mt30">시각적으로 안정되고, 손으로 만질 때 부드럽고 따뜻한 질감은<br /> 원목이 가진 가장 중요한 감성 디자인 요소입니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content28.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd07_01.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">칠판보조장</h5>
      ...
      <li class="p30">
        <img src="images/product/prd07_02.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">유아용교구장</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd07_03.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">유아용 탁자</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd07_04.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd07_05.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">잡지꽂이</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd07_06.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">교육용놀이세트</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd07_07.png" alt="" class="img-responsive center-block" />
