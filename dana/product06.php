  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide16.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">아이의 첫 공간은<br />감각을 통해 완성됩니다</h3>
          <p class="mt30 f20 white">아이가 처음으로 세상을 만나는 공간, 모든 감각이 안전하고 따뜻해야 합니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide17.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">보호와 자극, 균형을<br /> 고려한 설계</h3>
          <p class="mt30 f20 white">너무 많지도, 너무 적지도 않은 시각·촉각 자극은 아이의 인지 발달을 돕습니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide18.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">아이의 속도에<br /> 맞춘 공간</h3>
          <p class="mt30 f20 white">낮은 높이, 둥근 모서리, 간결한 동선. 아이의 눈높이에서 공간을 다시 생각합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>영아 보육실은 아이의 생애 첫 '사회적 공간'입니다. 신체적 안전을 최우선으로 고려하면서, 정서적 안정과 초기 인지 발달을 자연스럽게 자극할 수 있어야 합니다.</p>
        <p class="mt20">다나는 영아 보육공간을 "느낌으로 소통하는 공간"으로 정의합니다. 아이의 키와 손 높이에 맞춘 가구 설계, 부드러운 곡선 마감과 저자극 색상 구성, 조명, 소리, 온도, 질감까지 고려한 공간 배치, 특히, 다나의 원목가구는 내추럴한 감성과 무해한 친환경 자재를 활용해 '지나치게 어리지도, 차갑지도 않은' 유아 공간의 기준을 제시합니다.</p>
        <p class="mt20">유럽 유아가구의 감성을 반영하면서도 한국 유아 시설 기준(KC 인증 등)에 부합하는 내구성과 안전성을 갖추었습니다.</p>
        <img src="images/product/content21.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">안전성 확보</h5>
          <p>가구 전체에 라운딩 마감 적용, 날카로운 하드웨어 배제, 넘어짐·충돌에 대비한 구조 설계 등으로 물리적 사고 위험을 최소화합니다.<br /> 미끄럼 방지 처리와 원목 고정구조를 통해 안정감 있는 사용이 가능합니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">정서적 안정과 발달 자극</h5>
          <p>아이가 스스로 공간을 인식하고 탐색할 수 있도록 형태·질감·색상 자극이 절제된 환경을 설계합니다.<br /> 고정 가구와 이동 가구를 조합해 탐색성과 구조감을 동시에 제공합니다.</p>
        </li>
      </ul>
    </div>
  </div>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">저자극 컬러와 소재의 감성 설계</h5>
          <p class="mt30">밝고 부드러운 파스텔톤 중심의 색채 설계는<br /> 시각 피로도를 낮추고 아이의 감정 안정에 도움을 줍니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content22.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">낮은 높이의 안전 가구</h5>
          <p class="mt30">유아 전용 사이즈의 책장, 수납장, 의자 등은<br /> 자율성과 안전성을 동시에 충족시킵니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content23.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">공간 구획의 유연성</h5>
          <p class="mt30">놀이, 수면, 식사 등 다양한 활동을 고려해<br /> 파티션형 가구나 모듈형 매트를 활용한 안전한 영역 분리가 가능합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content24.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd06_01.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">붙박이장</h5>
      ...
      <li class="p30">
        <img src="images/product/prd06_02.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd06_03.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd06_04.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd06_05.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd06_06.png" alt="" class="img-responsive center-block" />
