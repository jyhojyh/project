  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide13.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">건강한 식사,<br />따뜻한 공간에서 시작됩니다</h3>
          <p class="mt30 f20 white">따뜻한 소재와 편안한 환경은 식사의 질을 높이고, 이용자에게 심리적 안정감을 제공합니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide14.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">위생, 동선, 편의가<br /> 조화를 이루는 급식 공간</h3>
          <p class="mt30 f20 white">이용자와 운영자 모두를 고려한 가구 설계와 공간 배치가 필수입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide15.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">모든 세대가<br /> 편안히 머무는 공간</h3>
          <p class="mt30 f20 white">연령대에 따라 다양한 높이, 좌석, 동선이 고려된 다층적 식사 환경이 필요합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>도서관 식당은 단순한 '식사 공간' 그 이상입니다.<br /> 공공성과 위생, 심미성과 기능성, 그리고 편의성과 안전성이 동시에 작동해야 하는 복합 환경입니다.</p>
        <p class="mt20">다나는 식당을 단순한 가구 배치가 아닌, 이용자 경험 중심의 라이프존으로 바라봅니다. 동선 흐름(입장-대기-식사-퇴식)의 효율화, 다양한 연령과 체형에 맞춘 좌석·테이블 비례, 청결과 내구성을 고려한 마감 재질과 구조 설계, 자연 친화적인 원목 가구는 시각적으로 따뜻함을 제공하며, 항균성과 내오염성을 갖춘 마감 처리는 공공 급식 환경에서 안전성과 위생을 동시에 충족합니다.</p>
        <p class="mt20">학교, 유치원, 복지시설 등 다양한 급식 공간에서도 가구의 확장성과 설계 유연성을 바탕으로 공간 최적화를 실현해왔습니다.</p>
        <img src="images/product/content17.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <ul class="mt60">
      <li class="flex flex-wrap items-center">
        <div class="wrap col-2">
          ...
          <h5 class="mt10 f30 fw8">안정적인 착석과 이동성 고려</h5>
          <p class="mt30">다양한 연령대 이용자에 맞춰 착석 시 안정감을 높이고,<br /> 이동이 편리한 가벼운 구조와 바닥 긁힘 방지 구조로 실용성을 확보합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content18.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">02</span>
          <h5 class="mt10 f30 fw8">공간 활용 유연성</h5>
          <p class="mt30">고정식, 접이식, 벤치형 등 다양한 테이블 유형을 상황에 맞게 구성 가능하며<br /> 필요 시 분리형 배치로 행사 공간 전환도 유연하게 대응할 수 있습니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content19.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
      <li class="flex flex-wrap items-center mt35">
        <div class="wrap col-2">
          <span class="mont f20 fw6 main-c">03</span>
          <h5 class="mt10 f30 fw8">원목의 온기와 내구성</h5>
          <p class="mt30">따뜻한 색감과 질감의 목재는 식사 공간의 긴장감을 줄이고,<br /> 충격에 강한 소재 구조와 단단한 마감으로 장기 사용에 적합합니다.</p>
        </div>
        <div class="wrap col-2">
          <img src="images/product/content20.png" alt="" class="img-responsive center-block" />
        </div>
      </li>
    </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd05_01.png" alt="" class="img-responsive center-block" />
