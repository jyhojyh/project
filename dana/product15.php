  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide43.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">하루의 리듬을 만드는<br /> 따뜻한 식사 공간</h3>
          <p class="mt30 f20 white">아늑한 조명, 부드러운 원목 가구, 깨끗하고 편안한 동선으로<br /> 아이들의 식사시간이 안정적으로 유지됩니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide44.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">함께 먹고, 함께 배우는 시간</h3>
          <p class="mt30 f20 white">아이들이 식사 예절을 익히고, 또래와 함께하는 즐거움을 느끼는<br /> 교육적·사회적 기능을 갖춘 공동 급식 공간입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide45.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">깨끗함과 안전함,<br /> 그리고 자율성까지</h3>
          <p class="mt30 f20 white">자율 배식, 개별 트레이, 위생 설비가 고려된 구조와<br /> 자연광과 환기까지 반영된 건강한 공간입니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        <p>유치원 식당은 아이들의 신체 성장, 정서 안정, 사회성 발달에 모두 영향을 미치는 중요한 공간입니다. 단순한 급식실을 넘어, 일상 속 학습의 무대가 되어야 합니다.</p>
        <p class="mt20">다나는 아이의 손 높이, 시야각, 활동성을 중심으로 식당을 설계합니다. 원목 가구는 따뜻한 감성과 정서적 안정감을 제공하며, 자연광과 간접조명, 안전한 모서리 처리, 비자극성 컬러톤으로 구성해 건강한 식습관 형성을 유도합니다. 자율성과 협동심을 키우는 구조를 위해 개별 테이블/자율배식대/식사 준비대 등을 고려합니다.</p>
        <p class="mt20">아이 키에 맞춘 원목 낮은 급식 테이블 설계와 개별 식판 보관함, 식기 반납대 등 자율 행동을 유도하는 설비 구성, 모서리 라운딩 처리 + 항균 마감재 적용, 오염 방지 기능성 표면 + 쉬운 청소를 고려한 배치 구조가 다나만의 차별 포인트 입니다.</p>
        <img src="images/product/content57.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
    ...
    <div class="considerations-grid">
      ...
      <ul class="mt60">
        <li class="flex flex-wrap items-center pt40 pb40">
          ...
          <h5 class="pl40 f24 fw5">안전한 가구 설계와 위생 환경</h5>
          <p>모서리 라운딩, 미끄럼 방지 발판, 항균 표면 마감 등은 아이들의 사고를 예방하고 청결을 유지하는 핵심 요소입니다.<br /> 공간은 청소가 쉽고 오염이 적은 재질로 구성되어야 하며, 환기 설비와 조명 환경도 고려되어야 합니다.</p>
        </li>
        <li class="flex flex-wrap items-center pt40 pb40">
          <span class="mont f20 fw7 main-c">02</span>
          <h5 class="pl40 f24 fw5">식사 경험을 통한 교육 효과</h5>
          <p>정돈된 식기 배치, 스스로 식사 준비와 정리를 할 수 있는 구조는 아이들에게 질서, 자율, 협동을 가르치는 교육적 도구가 됩니다.<br /> 다나는 가구 배치와 높이, 동선을 통해 이러한 경험을 자연스럽게 유도합니다.</p>
        </li>
      </ul>
    </div>
  </div>
...
<section class="keywords mt150">
  <h3 class="mont f18 fw6 main-c upper text-center">KEY WORDS</h3>
  <h4 class="mt20 f56 fw8 line3 text-center">실별 핵심 키워드</h4>
  <ul class="mt60">
    <li class="flex flex-wrap items-center">
      <div class="wrap col-2">
        <span class="mont f20 fw6 main-c">01</span>
        <h5 class="mt10 f30 fw8">자율 배식 구조 설계</h5>
        <p class="mt30">아이들이 스스로 식판을 받고, 정리하며 식사에 참여하게 하는<br /> 자율성과 책임감을 키우는 공간 구성입니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content58.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      <div class="wrap col-2">
        <span class="mont f20 fw6 main-c">02</span>
        <h5 class="mt10 f30 fw8">항균·안전 마감 가구</h5>
        <p class="mt30">자주 접촉하는 테이블·의자 표면은 항균 마감이 적용되고,<br /> 모서리와 다리 구조는 모두 둥글게 처리해 안전성을 확보합니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content59.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      <div class="wrap col-2">
        <span class="mont f20 fw6 main-c">03</span>
        <h5 class="mt10 f30 fw8">따뜻한 감성 환경</h5>
        <p class="mt30">밝고 자연스러운 원목의 결, 은은한 색감, 조용한 배경음과 간접조명은<br /> 아이들이 식사에 집중하고 정서적 안정을 느끼는 데 큰 도움이 됩니다.</p>
      </div>
      <div class="wrap col-2">
        <img src="images/product/content60.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
  </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd15_01.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">실험실용싱크대</h5>
      ...
      <li class="p30">
        <img src="images/product/prd15_02.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd15_03.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">실험기구진열장(냉장고)</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd15_04.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">실험기구진열장(전자렌지)</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd15_05.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">캐비닛(분리수거장)</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd15_06.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">실험기구진열장(정수기)</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd15_07.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">식탁</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd15_08.png" alt="" class="img-responsive center-block" />
