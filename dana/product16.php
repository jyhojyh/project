  ...
  <div class="swiper relative mt150">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="./images/product/slide46.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">01</h4>
          <h3 class="mt10 f42 white line2">하루의 에너지를<br /> 재충전하는 공간</h3>
          <p class="mt30 f20 white">업무 중 틈새 휴식과 점심시간, 퇴근 전 여유 등<br /> 교사들의 컨디션을 회복하는 중요한 쉼의 공간입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide47.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">02</h4>
          <h3 class="mt10 f42 white line2">소통과 공감이 이어지는 라운지</h3>
          <p class="mt30 f20 white">교사들 간의 일상 대화, 회의, 공유가 자연스럽게 이뤄지는<br /> 편안한 분위기의 커뮤니티형 휴게 공간입니다.</p>
        </div>
      </div>
      <div class="swiper-slide">
        <img src="./images/product/slide48.png" alt="" class="img-responsive center-block" />
        <div class="text-wrap absolute col-1 translate-y text-center">
          <h4 class="f20 fw6 main-c">03</h4>
          <h3 class="mt10 f42 white line2">원목의 온기로 감싸는 정서적 안정</h3>
          <p class="mt30 f20 white">심리적 긴장을 풀어주는 따뜻한 원목가구와 은은한 조명,<br /> 자연 채광으로 정서적 안정감을 제공합니다.</p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="flex mt20">
      ...
      <div class="right col-2">
        ...
        <img src="images/product/content61.png" alt="" class="img-responsive center-block mt40" />
      </div>
    </div>
  </div>
</section>
...
<section class="keywords mt150">
  ...
  <ul class="mt60">
    <li class="flex flex-wrap items-center">
      ...
      <div class="wrap col-2">
        <img src="images/product/content62.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      ...
      <div class="wrap col-2">
        <img src="images/product/content63.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
    <li class="flex flex-wrap items-center mt35">
      <div class="wrap col-2">
      ...
      <div class="wrap col-2">
        <img src="images/product/content64.png" alt="" class="img-responsive center-block" />
      </div>
    </li>
  </ul>
</section>
...
<section class="product-list mt150">
  <div class="container">
    ...
    <ul class="flex flex-wrap mt60">
      <li class="p30">
        <img src="images/product/prd16_01.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd16_02.png" alt="" class="img-responsive center-block" />
        <h5 class="mt20 f15 fw7 text-center">회의용탁자</h5>
        <div class="btn-box mt30 text-center">
          <a href="#" class="f0">
            <span class="inline-block align-middle"></span>
            <strong class="inline-block pl10 align-middle f18">더보기</strong>
      ...
      <li class="p30">
        <img src="images/product/prd16_03.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd16_04.png" alt="" class="img-responsive center-block" />
      ...
      <li class="p30">
        <img src="images/product/prd16_05.png" alt="" class="img-responsive center-block" />
