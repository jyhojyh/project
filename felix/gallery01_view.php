...
<section class="gallery01-content01-view notice notice-view pt90 mb100 sm-pt100 sm-mb100 xs-pt100 xs-mb100">
  <div class="container">
    <h2 class="f40 fw7 text-center">스노우멜팅</h2>
    <div class="line mt40 center-block"></div>
    <h3 class="mt60 f40 fw5">현대캐피탈 본관</h3>
    <h4 class="mt60 fw5">2017.03.22</h4>
    <div class="notice-view-content mt40 pt60 pb60">
      아래 내용은 예시글입니다.
    ...
    <div class="btn-box text-center f0">
      <a href="gallery01.php" class="inline-block mt40 pt15 pb15 pl60 pr60 text-center line0">목록</a>
    </div>
  </div>
</section>
