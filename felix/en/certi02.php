...
<section class="certi01-content01 certi02-content01 mt90 mb100 sm-mt100 sm-mb100 xs-mt100 xs-mb100">
  <div class="container">
    <div class="line-wrap" data-aos="fade-up">
      <h2 class="f40 fw7 text-center">Product Certifications</h2>
    ...
    <div class="tab flex flex-wrap justify-center items-center mt40" data-aos="fade-up">
      ...
      <div class="relative pb10 pr60 pl60 f20 text-center pointer">Metal Heater</div>
      <div class="relative pb10 pr60 pl60 f20 text-center pointer">Self-Regulating Heating Cable</div>
      <div class="relative pb10 pr60 pl60 f20 text-center pointer">Heating Cable</div>
    </div>
    <div class="certi-wrap" data-aos="fade-up">      
      <ul class="on flex flex-wrap mt70">
        <li>
          ...
          <h4 class="mt20 f20 fw6 text-center">ETL Certificate</h4>
      ...
      <ul class="flex flex-wrap mt70">
        ...
        <li class="mr25 lg-mr0 sm-mr0 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">ESTEC – Metal Heater Patent Certificate</h4>
        ...
        <li class="mr25 lg-mt50 sm-mr25 xs-mr0 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">ESTEC – Metal Heater CE Certification</h4>
        ...
        <li class="mt40 lg-mt50 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">ESTEC – Metal Heater UL Certification</h4>
      ...
      <ul class="flex flex-wrap mt70">
        ...
        <li class="mr25 lg-mr0 sm-mr0 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">CE Certification</h4>
        ...
        <li class="mr25 lg-mt50 sm-mr25 xs-mr0 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">EHL30-2 CE Certificate</h4>
          <h5 class="mt10 f18 fw5 text-center">2021.08.19</h5>
        </li>
        <li class="lg-mt50 sm-mr0 xs-mt50">
          <div class="img-wrap flex justify-center items-center">
          ...
          <h4 class="mt20 f20 fw6 text-center">FM System Certification</h4>
        ...
        <li class="mt40 lg-mt50 xs-mt50">
          ...
          <h4 class="mt20 f20 fw6 text-center">UL Certificate – XHT</h4>
