...
<section class="customer-content01 notice notice-view pt90 mb100 sm-pt100 sm-mb100 xs-pt100 xs-mb100">
  <div class="container">
    <h2 class="f40 fw7 text-center">Motice</h2>
    <div class="line mt40 center-block"></div>
    <div class="notice-view-top mt60">
      <ul>
        <li class="f0">
          <h3 class="inline-block pt20 pb20 pl20 f18 fw7 sm-pt10 sm-pb10 xs-pt10 xs-pb10">Title</h3>
          <h4 class="inline-block pt20 pb20 pl20 pr20 sm-pt10 sm-pb10 xs-pt10 xs-pb10">문의게시판의 질문입니다.</h4>
        </li>
        <li class="f0">
          <h3 class="inline-block pt20 pb20 pl20 f18 fw7 sm-pt10 sm-pb10 xs-pt10 xs-pb10">Date</h3>
          <h5 class="inline-block pt20 pb20 pl20 pr20 sm-pt10 sm-pb10 xs-pt10 xs-pb10">2024-12-06</h5>
          <h3 class="inline-block pt20 pb20 pl20 f18 fw7 sm-pt10 sm-pb10 xs-pt10 xs-pb10">View</h3>
          <h5 class="inline-block pt20 pb20 pl20 pr20 sm-pt10 sm-pb10 xs-pt10 xs-pb10">60</h5>
        </li>
        <li class="f0">
          <h3 class="inline-block pt20 pb20 pl20 f18 fw7 sm-pt10 sm-pb10 xs-pt10 xs-pb10">Attachment</h3>
    ...
    <div class="btn-box text-center f0">
      <a href="customer05.php" class="inline-block mt40 pt15 pb15 pl60 pr60 text-center line0">List</a>
    </div>
  </div>
</section>
