...
<section class="customer-content01 notice pt90 mb100 sm-pt100 sm-mb100 xs-pt100 xs-mb100">
  <div class="container">
    ...
    <table class="mt90">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="customer01_view.php">메탈히터와 필름히터 동파방지</a>
          </td>
        ...
        <tr>
          <td class="text-center hidden-xs">292</td>
          <td>
            <a href="customer01_view.php" class="block f0">
              <svg class="mr10 align-middle" data-name="그룹 11960" xmlns="http://www.w3.org/2000/svg" width="32"
                height="22.545" viewBox="0 0 32 22.545">
                <path data-name="사각형 3034" style="fill:#c4c8cb" d="M0 0h32v21H0z" />
                <text transform="translate(6 17.545)" style="fill:#fff;font-size:18px;font-family:AppleSDGothicNeoM00">
                  <tspan x="0" y="0">RE</tspan>
                </text>
              </svg>
              <span class="align-middle f16">메탈히터와 필름히터 동파방지</span>
            </a>
          </td>
          <td class="text-center">물류센터 설비</td>
          <td class="text-center hidden-xs">2025.06.17</td>
    ...
    <div class="btn-box text-right f0">
      <a href="customer01_write.php" class="inline-block mt40 pt15 pb15 pl55 pr55 text-center line0">Write</a>
    </div>
