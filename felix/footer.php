...
<section class="prd-footer bg-common pt160 pb160">
	<div class="container" data-aos="fade">
		...
		<div class="mt20 f0">
			<h3 class="inline-block f54 fw7 white line0 mr20 xs-mr10 xs-f20">엑셀 히팅시스템</h3>
			<p class="inline-block f24 fw3 white line0 upper xs-f18">excel heating system</p>
		</div>
		<ul class="btn-box mt40 f0">
			<li class="inline-block mr60 f0 pointer xs-col-1 xs-mr0">
				<span class="inline-block mr20 f20 white line2 align-middle">구매 SHOP 바로가기</span>
			...
			<li class="inline-block f0 pointer xs-col-1 xs-mt10" onclick="location.href='contact.php'">
				<span class="inline-block mr20 f20 white line2 align-middle">제품상담 바로가기</span>
				<svg class="align-middle" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
					<g data-name="그룹 11987" transform="translate(-711 -1882)">
							<circle data-name="타원 55" cx="18" cy="18" r="18" transform="translate(711 1882)" style="fill:#aa2d29"/>
							<g data-name="그룹 1963">
...
<div class="footer pt40 pb60 sm-pt40 sm-pb60 xs-pt40 xs-pb60">
	<div class="container">
		<div class="flex flex-wrap items-end justify-between">
			...
			<div class="right">
				<ul class="flex">
					<li class="mr50 xs-mr20"><a class="fw5 white" href="company01.php">펠릭스히팅시스템</a></li>
					<li class="mr50 xs-mr0"><a class="fw5 white" href="product01.php">제품소개</a></li>
					<li class="mr50 xs-mr20 xs-mt15"><a class="fw5 white" href="system01.php">시스템소개</a></li>
					<li class="mr50 xs-mr0 xs-mt15"><a class="fw5 white" href="certi01.php">인증</a></li>
					<li class="mr50 xs-mr20 xs-mt15"><a class="fw5 white" href="customer01.php">고객지원</a></li>
					<li class="xs-mt15"><a class="fw5 white" href="gallery01.php">시공사례</a></li>
				</ul>
			</div>
		</div>
