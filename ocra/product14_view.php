  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="prd-title mt50 pt30 flex flex-wrap items-end">
        <h3 class="rift f40 fw5 line1">OC-D2610008A</h3>
        <h4 class="pl25 f18 line1">26.0(W)x100.0(H)x19.8(D)mm FULL RANGE DRIVER (HIGH EFFICIENCY)</h4>
      </div>
      ...
      <div class="img-wrap mt20">
        <img src="./images/product/content39.jpg" alt="" class="img-responsive center-block" />
      </div>
...
<script type="module" src="./three_js/product_js/model05.js?ver=<?php echo time(); ?>"></script>
