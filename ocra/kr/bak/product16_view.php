  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="prd-title mt50 pt30 flex flex-wrap items-end">
        <h3 class="rift f40 fw5 line1">OC-D7714308A</h3>
        <h4 class="pl25 f18 line1">77.8(W)x143.4(H)x33.3(D)mm SLIM SUBWOOFER</h4>
      </div>
      ...
      <div class="img-wrap mt20">
        <img src="../images/product/content41.jpg" alt="" class="img-responsive center-block" />
      </div>
...
<script type="module" src="./three_js/product_js/model07.js?ver=<?php echo time(); ?>"></script>
