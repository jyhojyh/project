  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="view-top mt50 pt25 pb25">
        <h3 class="f20 fw6">새로운 홈페이지가 오픈되었습니다.</h3>
        <div class="mt30 f0">
      ...
      <div class="view-bottom">
        <div class="prev pt30 pb30 pl20 pr20 f0">
          <div class="inline-block align-middle f0">
            ...
            <span class="ml10 f14 fw5">이전</span>
          </div>
          <a class="inline-block align-middle fw5" href="#">새로운 홈페이지가 오픈되었습니다.</a>
        </div>
        <div class="next pt30 pb30 pl20 pr20 f0">
          <div class="inline-block align-middle f0">
            ...
            <span class="ml10 f14 fw5">다음</span>
          </div>
          <a class="inline-block align-middle fw5" href="#">새로운 홈페이지가 오픈되었습니다.</a>
        </div>
      </div>
      <div class="btn-box mt40 f0">
        <a class="inline-block p15 f18 fw6 text-center line1" href="notice_list.php">목록</a>
      </div>
    </div>
  </div>
</section>
