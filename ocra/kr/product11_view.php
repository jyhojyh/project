  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="img-wrap mt20">
        <img alt="" class="img-responsive center-block" src="../images/product/content36.jpg" />
      </div>
...
<script type="module" src="./three_js/product_js/model02.js?ver=<?php echo time(); ?>"></script>
